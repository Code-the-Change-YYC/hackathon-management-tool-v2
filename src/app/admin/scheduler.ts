...
export function createSchedule(teams: any[], rooms: any[], startTime: Date, duration: number) {
    let schedule: { teamName: string; roomName: string; judgeName: string, start: Date; end: Date; }[] = [];
